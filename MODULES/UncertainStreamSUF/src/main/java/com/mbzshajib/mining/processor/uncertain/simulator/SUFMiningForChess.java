...
public class SUFMiningForChess {
 ...
 public static void simulate() throws IOException, ProcessingError {
  ...
  List<MiningInput> miningInputs = MiningInputGenerator.generateMiningInputForChessDataSet();
 ...
 private static EvalutorInput getEvalutorInput(MiningInput miningInput) {
  ...
  input.setDataSetName("Chess");
  input.setResultFileName("result_Chess" + CURR_TIME + ".result");
